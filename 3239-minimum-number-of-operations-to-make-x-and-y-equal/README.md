<h2><a href="https://leetcode.com/problems/minimum-number-of-operations-to-make-x-and-y-equal">Minimum Number of Operations to Make X and Y Equal</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given two positive integers <code>x</code> and <code>y</code>.</p>
